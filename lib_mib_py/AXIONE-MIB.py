...
# by libsmi2pysnmp-0.1.3 at Tue Sep 10 15:18:41 2013,
...
axione_mib = ModuleIdentity((1, 3, 6, 1, 4, 1, 33923)).setRevisions(("2013-09-10 00:00","2013-08-23 00:00","2013-08-20 00:00","2013-08-14 00:00",)).setLabel("axione-mib")
...
if mibBuilder.loadTexts: baculaVersion.setDescription("Description de l'objet .1.1 : version de bacula")
baculaTotalClients = MibScalar((1, 3, 6, 1, 4, 1, 33923, 1, 2), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: baculaTotalClients.setDescription("Description de l'objet .1.2 : nombre de client bacula")
baculaClientsTable = MibTable((1, 3, 6, 1, 4, 1, 33923, 1, 3))
if mibBuilder.loadTexts: baculaClientsTable.setDescription("table contenant tout les clients")
baculaClientsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 33923, 1, 3, 1)).setIndexNames((0, "AXIONE-MIB", "baculaClientIndex"))
if mibBuilder.loadTexts: baculaClientsEntry.setDescription("les entrees de la table")
baculaClientIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 33923, 1, 3, 1, 1), CounterIndex()).setMaxAccess("readonly")
if mibBuilder.loadTexts: baculaClientIndex.setDescription("index de la table")
baculaClientName = MibTableColumn((1, 3, 6, 1, 4, 1, 33923, 1, 3, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: baculaClientName.setDescription("Nom des clients")
baculaClientError = MibTableColumn((1, 3, 6, 1, 4, 1, 33923, 1, 3, 1, 3), TrueFalse()).setMaxAccess("readonly")
...
baculaClientSizeBackup = MibTableColumn((1, 3, 6, 1, 4, 1, 33923, 1, 3, 1, 4), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: baculaClientSizeBackup.setDescription("Taille de la sauvegarde sur les dernieres 24h")
baculaClientTotalSizeBackup = MibTableColumn((1, 3, 6, 1, 4, 1, 33923, 1, 3, 1, 5), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: baculaClientTotalSizeBackup.setDescription("Taille de la sauvegarde sur tout les jobs")
baculaClientNumberFiles = MibTableColumn((1, 3, 6, 1, 4, 1, 33923, 1, 3, 1, 6), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: baculaClientNumberFiles.setDescription("Nombre de fichier sur les 24h")
baculaClientTotalNumberFiles = MibTableColumn((1, 3, 6, 1, 4, 1, 33923, 1, 3, 1, 7), Integer32()).setMaxAccess("readonly")
...
baculaGroupClients = ObjectGroup((1, 3, 6, 1, 4, 1, 33923, 0, 1, 2, 1)).setObjects(*(("AXIONE-MIB", "baculaClientError"), ("AXIONE-MIB", "baculaClientNumberFiles"), ("AXIONE-MIB", "baculaClientSizeBackup"), ("AXIONE-MIB", "baculaClientTotalNumberFiles"), ("AXIONE-MIB", "baculaClientName"), ("AXIONE-MIB", "baculaVersion"), ("AXIONE-MIB", "baculaClientTotalSizeBackup"), ("AXIONE-MIB", "baculaTotalClients"), ) )
